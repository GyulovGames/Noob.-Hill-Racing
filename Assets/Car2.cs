...
public class Car2 : MonoBehaviour
{
    ...
    [SerializeField] private Rigidbody2D rearWheel_RigidBody3;
    ...
    [SerializeField] private WheelJoint2D rearWheel_Joint3;
    ...
    [SerializeField] private CircleCollider2D rearWheel_CircleCollider3;
    ...
    {
        rearWheel_RigidBody3.AddTorque(-horizontal * engineForce * Time.fixedDeltaTime);
        rearWheel_RigidBody2.AddTorque(-horizontal * engineForce * Time.fixedDeltaTime);
        rearWheel_RigidBody1.AddTorque(-horizontal * frontWheelsForce * Time.fixedDeltaTime);
