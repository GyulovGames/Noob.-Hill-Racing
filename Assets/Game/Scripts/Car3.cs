...
public class Car3 : MonoBehaviour
{
    ...
    private void DownloadUpgrades()
    {
        ...
        {
            engineForce += 10 * YandexGame.savesData.Car3_Upgrades[0];
        }

        frontWheelsForce *= YandexGame.savesData.Car3_Upgrades[2];
        ...
        physicsMaterial.friction = wheelsGrip *= YandexGame.savesData.Car3_Upgrades[3];
        ...
        {
            fuelAmount += 5 * YandexGame.savesData.Car3_Upgrades[4];
        }
