...
public class Car1 : MonoBehaviour
{
    ...
    {
        if (YandexGame.savesData.Car1_Upgrades[0] > 1)
        {
            engineForce += 10 * YandexGame.savesData.Car1_Upgrades[0];
        }
        ...
        physicsMaterial.friction = wheelsGrip *= YandexGame.savesData.Car1_Upgrades[3];
        circleCollider1.sharedMaterial = physicsMaterial;
        circleCollider2.sharedMaterial = physicsMaterial;

        if (YandexGame.savesData.Car1_Upgrades[4] > 1)
        {
            fuelAmount += 5 * YandexGame.savesData.Car1_Upgrades[4];
        }
