...
public class Car2 : MonoBehaviour
{
    ...
    [SerializeField] private Rigidbody2D wheel_3Rigid;
    [SerializeField] private Rigidbody2D wheel_4Rigid;

    [Space(5)]
    [SerializeField] private WheelJoint2D wheelJoint1;
    [SerializeField] private WheelJoint2D wheelJoint2;
    [SerializeField] private WheelJoint2D wheelJoint3;
    [SerializeField] private WheelJoint2D wheelJoint4;

    [Space(5)]
    [SerializeField] private CircleCollider2D circleCollider1;
    [SerializeField] private CircleCollider2D circleCollider2;
    [SerializeField] private CircleCollider2D circleCollider3;
    [SerializeField] private CircleCollider2D circleCollider4;
    ...
    private void CarMovement()
    {
        ...
        wheel_2Rigid.AddTorque(-horizontal * frontWheelsForce * Time.fixedDeltaTime);

        wheel_3Rigid.AddTorque(-horizontal * engineForce * Time.fixedDeltaTime);
        wheel_4Rigid.AddTorque(-horizontal * engineForce * Time.fixedDeltaTime);
    }
    ...
    private void DownloadUpgrades()
    {
        ...
        {
            engineForce += 10 * YandexGame.savesData.Car2_Upgrades[0];
        }
        ...
        wheelJoint3.suspension = suspension;
        wheelJoint4.suspension = suspension;


        physicsMaterial.friction = wheelsGrip *= YandexGame.savesData.Car2_Upgrades[3];
        ...
        {
            fuelAmount += 5 * YandexGame.savesData.Car2_Upgrades[4];
        }
    }
