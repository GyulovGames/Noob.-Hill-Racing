...
public class Car5 : MonoBehaviour
{
    ...
    private void DownloadUpgrades()
    {
        ...
        {
            engineForce += 20 * YandexGame.savesData.Car5_Upgrades[0];
        }

        frontWheelsForce *= YandexGame.savesData.Car5_Upgrades[2];
        ...
        physicsMaterial.friction = wheelsGrip *= YandexGame.savesData.Car5_Upgrades[3];
        ...
        {
            fuelAmount += 5 * YandexGame.savesData.Car5_Upgrades[4];
        }
    }
